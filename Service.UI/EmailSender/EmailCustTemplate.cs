...
{
    public class EmailCustTemplate
    {
            private readonly IWebHostEnvironment _webHostEnvironment;

            public EmailCustTemplate(IWebHostEnvironment webHostEnvironment)
            {
            ...
            public bool CommonTemplate(string subject, string toEmail, string pageHeader, string Code)
            {
                ...
                string templatePath = Path.Combine(_webHostEnvironment.WebRootPath, "EmailTemplate", "CustomerTemplate.html");
